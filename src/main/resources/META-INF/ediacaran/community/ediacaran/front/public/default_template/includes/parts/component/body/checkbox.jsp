...
<label class="checkbox ${class}" <jsp:include page="/plugins/community/ediacaran/front/default_template/includes/parts/designer/properties.jsp" />>
  <input type="checkbox" name="${entity['name']}" value="${entity['value']}" ${entity['enabled'] == 'false'? ' disabled' : '' }
