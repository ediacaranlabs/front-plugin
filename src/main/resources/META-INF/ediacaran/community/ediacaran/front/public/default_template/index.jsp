...
<head>
  ...
  <!-- Fav and touch icons -->
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/plugins/community/ediacaran/front/default_template/ico/apple-touch-icon-144-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/plugins/community/ediacaran/front/default_template/ico/apple-touch-icon-114-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/plugins/community/ediacaran/front/default_template/ico/apple-touch-icon-72-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" href="/plugins/community/ediacaran/front/default_template/ico/apple-touch-icon-57-precomposed.png" />
  <link rel="shortcut icon" href="/plugins/community/ediacaran/front/default_template/ico/favicon.png" />
...
<body>
  <div id="wrapper">
    ...
    <jsp:include page="/plugins/community/ediacaran/front/${plugins.front.template}/includes/index/${vars['slider']['template']}.jsp"/>
    </c:if>

    <c:if test="${!empty vars['cta']}">
    <c:set var="item" value="${vars['cta']}" scope="request"/>
	<jsp:include page="/plugins/community/ediacaran/front/${plugins.front.template}/includes/index/${vars['cta']['template']}.jsp"/>
    </c:if>
    
    <section id="content">
      <div class="container">
      
	    <c:forEach items="${vars['itens']}" var="item" varStatus="_count">
			...
			<jsp:include page="/plugins/community/ediacaran/front/${plugins.front.template}/includes/index/${item['template']}.jsp"/>
      ...
      <div class="container">
	    ...
	    <c:forEach items="${vars['footer']['itens']}" var="item" varStatus="_count">
          <div class="span3">
            <div class="widget">
    		<c:set var="item" value="${item}" scope="request"/>
			<jsp:include page="/plugins/community/ediacaran/front/${plugins.front.template}/includes/index/widget/${item['template']}.jsp"/>
            </div>
          </div>
	    </c:forEach>
        </div>
