...
<div class="${barClass}" <jsp:include page="/plugins/community/ediacaran/front/default_template/includes/parts/designer/properties.jsp" />>
...
<div class="${contentClass}" <jsp:include page="/plugins/community/ediacaran/front/default_template/includes/parts/designer/properties.jsp" />>
	<article>
		<c:choose>
			<c:when test="${requestScope.entity.getClass().simpleName == 'String'}">
		     		${requestScope.entity}
