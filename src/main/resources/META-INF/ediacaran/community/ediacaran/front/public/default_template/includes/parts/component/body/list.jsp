...
<ul${!empty entity['type']? " class=\"".concat(entity['type']).concat(class).concat("\"")  : ''} <jsp:include page="/plugins/community/ediacaran/front/default_template/includes/parts/designer/properties.jsp" />>
