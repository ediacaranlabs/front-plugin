...
<button ${attr} class="${class}" <c:if test="${empty requestScope.formControls}">class="${class}" <jsp:include page="/plugins/community/ediacaran/front/default_template/includes/parts/designer/properties.jsp" /></c:if>>
${entity['label']}
</button>
<c:if test="${requestScope.formControls}">
		</div>
