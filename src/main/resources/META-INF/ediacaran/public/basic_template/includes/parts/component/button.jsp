...
<button ${attr} class="${class}" <c:if test="${empty requestScope.formControls}">class="${class}" <jsp:include page="/plugins/ediacaran/front/basic_template/includes/parts/designer/properties.jsp" /></c:if>>
${entity['label']}
</button>
