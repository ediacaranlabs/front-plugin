...
@Singleton
@Controller(value="${plugins.ediacaran.front.manager_context}")
@View(value="${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/index")
@Actions({
	@Action(value="/plugins", view=@View(value="${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/plugins"))
})
@ResponseErrors(rendered=false, name="exception")
public class ManagerPubResource {
	...
	public ManagerPubResource(){
	}

	@Action(value="/plugins/{code:[a-zA-Z0-9]+((\\-|\\_)[a-zA-Z0-9]+)*}")
	@View("${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/plugin-detail")
	...
	@Action(value="/plugins/{code:[a-zA-Z0-9]+((\\-|\\_)[a-zA-Z0-9]+)*}")
	@RequestMethod("POST")
	@View("${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/update-plugin-detail")
	...
	@RequestMethod("POST")
	@View("${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/update-status-plugin-detail")
	@Result(value="vars", mappingType=MappingTypes.VALUE)
	...
	@RequestMethod("POST")
	@View("${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/update-install-file")
	...
	@RequestMethod("POST")
	@View("${plugins.ediacaran.front.template}${plugins.ediacaran.front.manager_context}/uninstall-plugin")
