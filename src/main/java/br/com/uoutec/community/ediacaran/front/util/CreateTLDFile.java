package br.com.uoutec.community.ediacaran.front.util;
...
import br.com.uoutec.application.scanner.Scanner;
...
public class CreateTLDFile {

	private static final String TAB = "     ";
	
	@SuppressWarnings("unchecked")
	public void create(Scanner scanner) throws InstantiationException, IllegalAccessException, FileNotFoundException, IOException {
		...
		List<Class<?>> clazzList = scanner.getClassList();
	...
	private StringBuilder toXML(Tag tag, TagDoc doc, Class<?> type) {
		StringBuilder b = new StringBuilder();
	...
	private StringBuilder toXML(String prefix, TagAttribute tag, TagDoc doc, Method m) {
		StringBuilder b = new StringBuilder();
